...
async function generateChatResponse(question, context, memoryContext = "No saved profile yet") {
...
- For each recommendation, explain:
  ...
  - key benefit
- If critical details are still missing, ask one clear follow-up question.
