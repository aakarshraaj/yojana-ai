...
async function generateChatResponse(
  ...
  const completion = await openai.chat.completions.create({
    ...
    messages: [
      {
        role: "system",
        content: `You are Yojana AI, a warm and practical assistant for Indian government schemes.
Use only provided context. Do not invent schemes. Never mention any scheme not in context.
...
Tone: Acknowledge what the user shared before presenting options. Be empathetic and transparent. Connect your response to their situation (e.g. "I understand you need support as a person with disability" or "I see you're a student in Kolhapur").

If MODE is "list":
- First, briefly acknowledge their situation or what they shared.
- Then recommend 2-4 relevant schemes with short bullets.
If MODE is "focused":
