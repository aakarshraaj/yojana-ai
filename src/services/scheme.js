...
function buildDeterministicList(matches, profileState = null) {
  ...
  lines.push(
    stateTitle
      ? `Based on what you shared, I searched for schemes in **${stateTitle}** and found these options that may help:`
      : "Based on what you shared, I found these schemes that may help:"
  );
  lines.push("");
  ...
  lines.push("You can reply with the number (1, 2, 3, or 4) or the scheme name to get full details.");
